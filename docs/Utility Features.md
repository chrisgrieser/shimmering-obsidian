...
> [!NOTE]
> Open your vault root with the [Vault Switcher](Vault%20Switcher.md), and local
> plugin folders with the [Plugin Settings
> Search](Settings%20and%20Local%20Plugin%20Search.md).
