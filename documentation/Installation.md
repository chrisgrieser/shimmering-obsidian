...
- After installing the workflow, you need to configure the settings of this workflow to make use of most of its features. Refer to the [Workflow Configuration](documentation/Workflow Configuration.md) for further information.
- Do **not** change the default settings of the metadata extractor plugin, regarding the name and location of the metadata files, otherwise this workflow will not be able to read them. For further information, see the [respective section of the workflow configuration](documentation/Workflow Configuration#Metadata Extractor Settings).
